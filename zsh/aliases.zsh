...
# Alias for searching file names only
alias fzf-f='find . -type f | fzf --height 40% --border --preview "bat --style=numbers --color=always {} || cat {}"'

# Alias for searching strings within all files under the current directory
alias fzf-w='rg --files-with-matches --hidden --ignore .git | fzf --height 60% --border --preview "bat --style=numbers --color=always {} || cat {}"'

# Alias for searching file names under home directory, excluding cache and temp directories
alias fzf-all='find ~ \( -path "$HOME/cache" -o -path "$HOME/temp" \) -prune -o -type f -print | fzf --height 50% --border --preview "bat --style=numbers --color=always {} || cat {}"'
alias fzf-a='find ~ \( -path "$HOME/cache" -o -path "$HOME/temp" \) -prune -o -type f -print | fzf --height 50% --border --preview "bat --style=numbers --color=always {} || cat {}"'

# Search for text inside files in current directory
alias fzf-w='rg --color=always --line-number --no-heading --smart-case "" | fzf --ansi --height 60% --border --delimiter : --preview "bat --style=numbers --color=always {1}" --preview-window right:60%'
